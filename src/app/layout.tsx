  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="oussman-barber-shop-barberia";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Oussman Barber Shop | barbería barcelona | La mejor barbería de Barcelona"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="oussman-barber-shop-barberia"
          data-primary-color="#37384f"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="oussman-barber-shop-barberia";
